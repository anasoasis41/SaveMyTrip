package com.riahi.savemytrip.tripbook;
...
import com.riahi.savemytrip.utils.StorageUtils;
...
public class TripBookActivity extends BaseActivity {
    ...
    private static final String AUTHORITY="com.riahi.savemytrip.fileprovider";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_share:
                // Call the sharing when user clicked on share button
                this.shareFile();
                return true;
