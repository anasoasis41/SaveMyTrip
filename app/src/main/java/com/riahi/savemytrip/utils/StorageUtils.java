package com.riahi.savemytrip.utils;
...
/**
 *  Cette classe sera responsable de la sauvegarde et de la récupération des données
 *  inscrites au sein de notre fichier tripBook.txt
 */

public class StorageUtils {

    /**
     * Cette méthode sera appelée pour créer ou récupérer un fichier
     * @param destination
     * @param fileName
     * @param folderName
     * @return
